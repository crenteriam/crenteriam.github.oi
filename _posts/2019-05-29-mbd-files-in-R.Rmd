...
library(RODBC)
path = file.path("C:/Users/rente/OneDrive/Escritorio/sadc_2017_national/sadc_2017_national")
channel.sadc <- odbcConnectAccess(path) # The object channel.sadc is an sql file.
```
...
library(haven)
write_dta(data.sadc2017, "C:/Users/rente/OneDrive/Escritorio/SADC_2017_National.dta")
```
